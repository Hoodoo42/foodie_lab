// Restaurant home is thie landing page allowing them access to things only accesible by singed in restaurants
// need to add access to other restaurants info
...
export default {
  ...
  restaurant_deets: cookies.get(`restaurant_id`),
  data() {
    return {
